(function($) { $(document).ready(function(){
  ...
  $("footer").on("click", ".content a", function(event) { event.preventDefault(); $("footer .content div").toggle(); });

  $('a.popup').click(function(event) { 
    event.preventDefault(); 
    $("div#popgray").fadeIn(100);
    $("div#popup").load("devs.html section#"+$(this).attr('data'), function(response, status, xhr) {
      if(status == "success") {
